...
| [host_link_migration.md](host_link_migration.md) | Active migration ledger: HL0 resolved, HL1–HL4 planned; planning ownership, pure wire library, typed core-control contract, serial-link decomposition, and acceptance gates. |
