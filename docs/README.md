...
| [verification.md](verification.md) | P1.6 verification approach: cycle-exact model comparison, expect tests and Quickcheck, environment/runner ownership, seed replay, observation validity, and pin-to-item monitors. |
