...
| [`Firmware_uart`](../model/firmware_uart.ml) | Typed, validated 8N1 TX descriptor used as the independent model-side sequence for the first slice. | Its cycle trace matches the UART hardware transmitter for the same byte and timing. |
